namespace Durable.SqlServer
{
    ...
    /// <summary>
    /// Represents a grouping of elements with a common key for MySQL grouped query operations.
    ...
    internal class SqlServerGrouping<TKey, TElement> : IGrouping<TKey, TElement>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the SqlServerGrouping class.
        /// </summary>
        ...
        public SqlServerGrouping(TKey key, IEnumerable<TElement> elements)
        {
            if (elements == null)
