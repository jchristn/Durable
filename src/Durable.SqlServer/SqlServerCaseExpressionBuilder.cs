namespace Durable.SqlServer
{
    ...
    internal class SqlServerCaseExpressionBuilder<TEntity> : ICaseExpressionBuilder<TEntity> where TEntity : class, new()
    {
        ...
        /// <summary>
        /// Initializes a new instance of the SqlServerCaseExpressionBuilder with the specified query builder and repository.
        /// </summary>
        ...
        public SqlServerCaseExpressionBuilder(SqlServerQueryBuilder<TEntity> queryBuilder, SqlServerRepository<TEntity> repository)
        {
        ...
        public IQueryBuilder<TEntity> EndCase(string alias)
        {
            ...
            string caseExpressionSql = BuildSqlServerCaseExpression();
        ...
        /// Uses the full SqlServerExpressionParser to support complex expressions, method calls,
        ...
        {
            // Use the full SqlServerExpressionParser for comprehensive expression support
            SqlServerExpressionParser<TEntity> parser = new SqlServerExpressionParser<TEntity>(
        ...
        private string BuildSqlServerCaseExpression()
        {
