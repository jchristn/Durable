namespace Durable.SqlServer
{
    ...
    /// </summary>
    internal class SqlServerIncludeInfo
    {
        ...
        /// </summary>
        public SqlServerIncludeInfo? Parent { get; set; }

        /// <summary>
        /// Gets or sets the collection of child includes for nested navigation properties.
        /// </summary>
        public List<SqlServerIncludeInfo> Children { get; set; } = new List<SqlServerIncludeInfo>();
        ...
        /// <summary>
        /// Initializes a new instance of the SqlServerIncludeInfo class.
        /// </summary>
        public SqlServerIncludeInfo()
        {
        }
