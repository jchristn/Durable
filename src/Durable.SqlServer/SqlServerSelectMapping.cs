namespace Durable.SqlServer
{
    ...
    /// <summary>
    /// Maps database columns to entity properties for projection queries in MySQL.
    /// Handles SELECT clause mapping and data type conversions.
    /// </summary>
    internal class SqlServerSelectMapping
    {
        ...
        /// <summary>
        /// Initializes a new instance of the SqlServerSelectMapping.
        /// </summary>
        public SqlServerSelectMapping()
        {
        }

        /// <summary>
        /// Initializes a new instance of the SqlServerSelectMapping with the specified property and column.
        /// </summary>
        ...
        public SqlServerSelectMapping(PropertyInfo targetProperty, string sourceColumn)
        {
        ...
        /// <returns>A collection of SqlServerSelectMapping objects</returns>
        /// <exception cref="ArgumentNullException">Thrown when columnMappings is null</exception>
        public static IEnumerable<SqlServerSelectMapping> FromColumnMappings(Dictionary<string, PropertyInfo> columnMappings)
        {
            if (columnMappings == null)
                throw new ArgumentNullException(nameof(columnMappings));

            List<SqlServerSelectMapping> mappings = new List<SqlServerSelectMapping>();

            foreach (KeyValuePair<string, PropertyInfo> kvp in columnMappings)
            {
                mappings.Add(new SqlServerSelectMapping(kvp.Value, kvp.Key));
            }
        ...
        /// <returns>A collection of SqlServerSelectMapping objects</returns>
        public static IEnumerable<SqlServerSelectMapping> ForResultType<TResult>() where TResult : new()
        {
            List<SqlServerSelectMapping> mappings = new List<SqlServerSelectMapping>();
            ...
            foreach (PropertyInfo property in resultType.GetProperties())
            {
                if (property.CanWrite)
                {
                    ...
                    mappings.Add(new SqlServerSelectMapping(property, columnName));
                }
            }
        ...
        /// <summary>
        /// Determines if type conversion will be required for the given property type.
        /// </summary>
        /// <param name="propertyType">The property type to check</param>
        /// <returns>True if conversion is likely required, false otherwise</returns>
        ...
        /// <summary>
        /// Checks if a type is a primitive type that typically doesn't need conversion.
        /// </summary>
