namespace Durable.SqlServer
{
    ...
    internal class SqlServerGroupedQueryBuilder<TEntity, TKey> : IGroupedQueryBuilder<TEntity, TKey> where TEntity : class, new()
    {
        ...
        private readonly SqlServerQueryBuilder<TEntity> _QueryBuilder;
        ...
        private readonly List<SqlServerAggregateInfo> _Aggregates;
        ...
        /// <summary>
        /// Initializes a new instance of the SqlServerGroupedQueryBuilder class.
        /// </summary>
        /// <param name="repository">The MySQL repository instance</param>
        /// <param name="queryBuilder">The MySQL query builder instance</param>
        ...
        public SqlServerGroupedQueryBuilder(
            SqlServerRepository<TEntity> repository,
            SqlServerQueryBuilder<TEntity> queryBuilder,
            Expression<Func<TEntity, TKey>> keySelector,
            SqlServerEntityMapper<TEntity> entityMapper,
            ...
            ISanitizer sanitizer)
        {
            ...
            _Aggregates = new List<SqlServerAggregateInfo>();
        }
            ...
            try
            {
                ...
                else
                {
                    ...
                    return allEntities.GroupBy(keyExtractor)
                                     .Select(g => new SqlServerGrouping<TKey, TEntity>(g.Key, g));
                }
            }
            catch (Exception ex)
            {
                ...
                foreach (MemberBinding binding in memberInit.Bindings)
                {
                        ...
                        assignment.Expression is MethodCallExpression methodCall)
                    {
                        ...
                        if (aggregate != null)
                        {
                            ...
                            _Aggregates.Add(new SqlServerAggregateInfo
                            {
                                Function = aggregate,
                                Alias = alias
                            });
        ...
        private struct SqlServerAggregateInfo
        {
