namespace Durable.SqlServer
{
    ...
    public static class SqlServerConnectionFactoryExtensions
    {
        ...
        public static SqlServerConnectionFactory CreateSqlServerFactory(
            string server,
            string database,
            string userId,
            string password,
            ...
            string sslMode = "Preferred")
        {
            ...
            return new SqlServerConnectionFactory(builder.ConnectionString, poolOptions);
        }
        ...
        public static SqlServerConnectionFactory CreateLocalSqlServerFactory(
            string database,
            string userId = "root",
            string password = "",
        ...
        public static SqlServerConnectionFactory CreateProductionSqlServerFactory(
            string server,
            string database,
            string userId,
            string password,
