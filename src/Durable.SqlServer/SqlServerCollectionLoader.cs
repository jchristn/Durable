namespace Durable.SqlServer
{
    ...
    internal class SqlServerCollectionLoader<T> where T : class, new()
    {
        ...
        /// <summary>
        /// Initializes a new instance of the SqlServerCollectionLoader class.
        /// </summary>
        ...
        public SqlServerCollectionLoader(ISanitizer sanitizer, IDataTypeConverter dataTypeConverter)
        {
        ...
        private object CreateEntityFromReader(SqlDataReader reader, Type entityType)
        {
        ...
        private object? GetValueFromReader(SqlDataReader reader, string columnName, Type? targetType)
        {
            try
            {
