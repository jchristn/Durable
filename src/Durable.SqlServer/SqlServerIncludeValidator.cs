namespace Durable.SqlServer
{
    ...
    /// </summary>
    internal class SqlServerIncludeValidator
    {
        ...
        /// <summary>
        /// Initializes a new instance of the SqlServerIncludeValidator class.
        /// </summary>
        ...
        public SqlServerIncludeValidator(int maxIncludeDepth = 5)
        {
