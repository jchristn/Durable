namespace Test.SqlServer
{
    ...
    /// <summary>
    /// Tests for boolean value conversion in SqlServerDataTypeConverter.
    /// Verifies that various input formats (numeric, string) are correctly converted to boolean values.
    /// SQL Server stores booleans as BIT type, which can return bool, int, or byte.
    /// </summary>
    public class BooleanConversionTests
    {
        private readonly SqlServerDataTypeConverter _Converter;
        ...
        {
            _Converter = new SqlServerDataTypeConverter();
        }
        ...
        /// This was previously a bug where bool.Parse("1") would throw.
        /// </summary>
        [Fact]
        ...
        /// This was previously a bug where bool.Parse("0") would throw.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Tests that string "0" converts to false for nullable bool.
        /// </summary>
        [Fact]
        public void ConvertFromDatabase_StringZero_ReturnsFalseForNullableBool()
        {
            object? result = _Converter.ConvertFromDatabase("0", typeof(bool?));
            Assert.NotNull(result);
            Assert.False((bool)result!);
