    ...
    public class SqlServerConcurrencyIntegrationTests : IDisposable
    {
        ...
        public void ClientWinsResolver_ResolvesConflict()
        {
            ...
            try
            {
                ...
                using (SqlServerRepository<Author> repo = new SqlServerRepository<Author>(_connectionString, null, null, resolver))
                {
                    CleanupTestData(repo);
        ...
        private void CleanupTestData(SqlServerRepository<Author> repo)
        {
            try
            {
                // Ensure table exists first
        ...
        private void EnsureTableExists(SqlServerRepository<Author> repo)
        {
            try
            {
        ...
        private void EnsureTableExistsWithoutVersion(SqlServerRepository<Author> repo)
        {
            try
            {
