...
{
    /// <summary>
    /// Manual test runner for SQL Server integration tests.
    /// This can be used to run tests programmatically outside of a test framework.
    /// </summary>
    public static class SqlServerTestRunner
    {
        /// <summary>
        /// Runs all SQL Server integration tests and reports results.
        /// </summary>
        ...
        public static async Task RunAllTests()
        {
            ...
            {
                Console.WriteLine("All tests passed, but some were skipped (likely due to missing SQL Server).");
