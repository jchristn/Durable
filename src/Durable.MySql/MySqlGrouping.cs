namespace Durable.MySql
{
    ...
    internal class MySqlGrouping<TKey, TElement> : IGrouping<TKey, TElement>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the MySqlGrouping class.
        /// </summary>
        ...
        public MySqlGrouping(TKey key, IEnumerable<TElement> elements)
        {
            if (elements == null)
