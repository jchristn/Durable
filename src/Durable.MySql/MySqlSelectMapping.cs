namespace Durable.MySql
{
    ...
    /// </summary>
    internal class MySqlSelectMapping
    {
        ...
        /// <summary>
        /// Initializes a new instance of the MySqlSelectMapping.
        /// </summary>
        public MySqlSelectMapping()
        {
        }

        /// <summary>
        /// Initializes a new instance of the MySqlSelectMapping with the specified property and column.
        /// </summary>
        ...
        public MySqlSelectMapping(PropertyInfo targetProperty, string sourceColumn)
        {
        ...
        /// <returns>A collection of MySqlSelectMapping objects</returns>
        /// <exception cref="ArgumentNullException">Thrown when columnMappings is null</exception>
        public static IEnumerable<MySqlSelectMapping> FromColumnMappings(Dictionary<string, PropertyInfo> columnMappings)
        {
            if (columnMappings == null)
                throw new ArgumentNullException(nameof(columnMappings));

            List<MySqlSelectMapping> mappings = new List<MySqlSelectMapping>();

            foreach (KeyValuePair<string, PropertyInfo> kvp in columnMappings)
            {
                mappings.Add(new MySqlSelectMapping(kvp.Value, kvp.Key));
            }
        ...
        /// <returns>A collection of MySqlSelectMapping objects</returns>
        public static IEnumerable<MySqlSelectMapping> ForResultType<TResult>() where TResult : new()
        {
            List<MySqlSelectMapping> mappings = new List<MySqlSelectMapping>();
            ...
            foreach (PropertyInfo property in resultType.GetProperties())
            {
                if (property.CanWrite)
                {
                    ...
                    mappings.Add(new MySqlSelectMapping(property, columnName));
                }
            }
