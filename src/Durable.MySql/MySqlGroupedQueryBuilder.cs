namespace Durable.MySql
{
    ...
    internal class MySqlGroupedQueryBuilder<TEntity, TKey> : IGroupedQueryBuilder<TEntity, TKey> where TEntity : class, new()
    {
        ...
        private readonly List<MySqlAggregateInfo> _Aggregates;
        ...
        /// <summary>
        /// Initializes a new instance of the MySqlGroupedQueryBuilder class.
        /// </summary>
            ...
            ISanitizer sanitizer)
        {
            ...
            _Aggregates = new List<MySqlAggregateInfo>();
        }
                ...
                foreach (MemberBinding binding in memberInit.Bindings)
                {
                        ...
                        assignment.Expression is MethodCallExpression methodCall)
                    {
                        ...
                        if (aggregate != null)
                        {
                            ...
                            _Aggregates.Add(new MySqlAggregateInfo
                            {
                                Function = aggregate,
                                Alias = alias
                            });
        ...
        private struct MySqlAggregateInfo
        {
