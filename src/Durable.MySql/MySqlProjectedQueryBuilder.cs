namespace Durable.MySql
{
    ...
    public class MySqlProjectedQueryBuilder<TEntity, TResult> : IQueryBuilder<TResult>
        ...
        where TResult : class, new()
    {
        ...
        /// <summary>
        /// Initializes a new instance of the MySqlProjectedQueryBuilder class.
        /// </summary>
        ...
        public MySqlProjectedQueryBuilder(
            MySqlRepository<TEntity> repository,
            Expression<Func<TEntity, TResult>> selector,
            MySqlQueryBuilder<TEntity> sourceQueryBuilder,
        ...
        private string BuildSqlInternal()
        {
            ...
            if (_SkipCount.HasValue || _TakeCount.HasValue)
            {
                ...
                {
                    sql.Append($"{_SkipCount.Value}, ");
                }
                if (_TakeCount.HasValue)
                {
                    sql.Append(_TakeCount.Value.ToString());
                }
        ...
        private IEnumerable<TResult> MapResults(MySqlDataReader reader)
        {
            while (reader.Read())
            {
        ...
        private async IAsyncEnumerable<TResult> MapResultsAsync(MySqlDataReader reader, [EnumeratorCancellation] CancellationToken token)
        {
        ...
        private TResult CreateResultInstance(MySqlDataReader reader)
        {
