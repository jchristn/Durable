namespace Durable.MySql
{
    ...
    internal class MySqlCaseExpressionBuilder<TEntity> : ICaseExpressionBuilder<TEntity> where TEntity : class, new()
    {
        ...
        /// Uses the full MySqlExpressionParser to support complex expressions, method calls,
        ...
        {
            // Use the full MySqlExpressionParser for comprehensive expression support
