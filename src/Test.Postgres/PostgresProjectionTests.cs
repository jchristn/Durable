namespace Test.Postgres
{
    ...
    /// </summary>
    public class PostgresProjectionTests : IDisposable
    {
        #region Private-Members

        private const string TestConnectionString = "Host=localhost;Database=durable_projection_test;Username=test_user;Password=test_password;";
        ...
        /// </summary>
        public PostgresProjectionTests()
        {
            lock (_TestLock)
            {
        ...
        public async Task TestDistinctProjections()
        {
            ...
            var uniqueCombinations = deptList
        ...
        private void SetupTestDatabase()
        {
            try
            {
                ...
                Console.WriteLine("✅ PostgreSQL projection tests enabled - database connection successful");
            }
            catch (Exception ex)
            {
                Console.WriteLine($"⚠️  PostgreSQL projection tests disabled - could not connect to database: {ex.Message}");
                Console.WriteLine("To enable PostgreSQL projection tests:");
        ...
        private void CreateTables()
        {
            ...
            _PersonRepository.ExecuteSql("CREATE INDEX idx_last_name ON people (last)");
        ...
        public class DepartmentSummary
        {
            ...
            /// <summary>
            /// Gets or sets the sample salary range category.
            /// </summary>
        ...
        public class EmployeeProfile
        {
            ...
            /// <summary>
            /// Gets or sets the work information.
            /// </summary>
            ...
            /// <summary>
            /// Gets or sets a value indicating whether the employee is a high earner.
            /// </summary>
            public bool IsHighEarner { get; set; }

            /// <summary>
            /// Gets or sets the years remaining until retirement.
            /// </summary>
        ...
        public class AdvancedEmployeeMetrics
        {
            ...
            /// <summary>
            /// Gets or sets the age group category.
            /// </summary>
            public string AgeGroup { get; set; } = "";

            /// <summary>
            /// Gets or sets the salary tier category.
            /// </summary>
            public string SalaryTier { get; set; } = "";

            /// <summary>
            /// Gets or sets the estimated annual bonus amount.
            /// </summary>
            public decimal EstimatedAnnualBonus { get; set; }

            /// <summary>
            /// Gets or sets the monthly take-home pay after taxes.
            /// </summary>
            ...
            /// <summary>
            /// Gets or sets a value indicating whether the employee is eligible for promotion.
            /// </summary>
            public bool IsEligibleForPromotion { get; set; }

            /// <summary>
            /// Gets or sets the yearly growth potential amount.
            /// </summary>
