namespace Test.Postgres
{
    ...
    /// <summary>
    /// Tests for boolean value conversion in PostgresDataTypeConverter.
    /// Verifies that various input formats (numeric, string) are correctly converted to boolean values.
    /// PostgreSQL has native BOOLEAN type, but this tests conversion from various formats for flexibility.
    /// </summary>
    public class BooleanConversionTests
    {
        private readonly PostgresDataTypeConverter _Converter;
        ...
        {
            _Converter = new PostgresDataTypeConverter();
        }
