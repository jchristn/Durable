namespace Test.Postgres
{
    ...
    /// <summary>
    /// Comprehensive performance and configuration tests for PostgreSQL batch insert operations including:
    ...
    /// </summary>
    public class PostgresBatchInsertTests : IDisposable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PostgresBatchInsertTests"/> class.
        /// </summary>
        /// <param name="output">The test output helper for logging test results.</param>
        public PostgresBatchInsertTests(ITestOutputHelper output)
        {
            _output = output;
            _connectionString = "Host=localhost;Database=durable_batch_test;Username=test_user;Password=test_password;";
        ...
        /// <summary>
        /// Tests the batch insert configuration with different parameter limits for PostgreSQL optimization.
        /// </summary>
        ...
        /// <summary>
        /// Creates or recreates the people table with proper PostgreSQL schema.
        /// </summary>
        private async Task CreateTableAsync(PostgresRepository<Person> repository)
        {
        ...
        /// </summary>
        private async Task SetupDatabase(PostgresRepository<Person> repository)
        {
            await repository.ExecuteSqlAsync(@"
                ...
                CREATE INDEX idx_department ON people (department);
