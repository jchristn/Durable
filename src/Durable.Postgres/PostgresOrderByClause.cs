namespace Durable.Postgres
{
    ...
    /// </summary>
    internal class PostgresOrderByClause
    {
        ...
        public PostgresOrderByClause(string column, OrderDirection direction)
        {
        ...
        {
            if (obj is PostgresOrderByClause other)
            {
