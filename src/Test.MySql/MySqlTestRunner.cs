...
namespace Test.MySql
{
    ...
    public static class MySqlTestRunner
    {
        ...
        public static async Task RunAllTests()
        {
            ...
            TestResults integrationResults = await RunTestClass<MySqlIntegrationTests>("MySQL Integration Tests");
            ...
            TestResults advancedResults = await RunTestClass<MySqlAdvancedQueryBuilderTests>("MySQL Advanced Query Builder Tests");
            ...
            TestResults includeResults = await RunTestClass<MySqlIncludeTests>("MySQL Include/Join Tests");
            ...
            TestResults groupByResults = await RunTestClass<MySqlGroupByTests>("MySQL GROUP BY Tests");
            ...
            TestResults projectionResults = await RunTestClass<MySqlProjectionTests>("MySQL Projection Tests");
            ...
            TestResults expressionResults = await RunTestClass<MySqlComplexExpressionTests>("MySQL Complex Expression Tests");
            ...
            TestResults transactionResults = await RunTestClass<MySqlTransactionScopeTests>("MySQL Transaction Scope Tests");
            ...
            TestResults concurrencyResults = await RunTestClass<MySqlConcurrencyIntegrationTests>("MySQL Concurrency Control Tests");
            ...
            TestResults dataTypeResults = await RunTestClass<MySqlDataTypeConverterTests>("MySQL Data Type Converter Tests");
            ...
            TestResults batchInsertResults = await RunTestClass<MySqlBatchInsertTests>("MySQL Performance & Configuration Tests");
            ...
            TestResults entityRelationshipResults = await RunTestClass<MySqlEntityRelationshipTests>("MySQL Entity Relationships & Complex Models Tests");
