namespace Test.MySql
{
    ...
    /// <summary>
    /// Comprehensive data type conversion and mapping tests for MySQL including:
    ...
    /// </summary>
    public class MySqlDataTypeConverterTests : IDisposable
    {
        private readonly ITestOutputHelper _output;
        private readonly string _connectionString;
        private readonly bool _skipTests;

        public MySqlDataTypeConverterTests(ITestOutputHelper output)
        {
            _output = output;
            _connectionString = "Server=localhost;Database=durable_datatype_test;User=test_user;Password=test_password;";
        ...
        /// </summary>
        private async Task CreateTableAsync(MySqlRepository<ComplexEntity> repository)
        {
            ...
            try
            {
                await repository.ExecuteSqlAsync("ALTER TABLE complex_entities MODIFY COLUMN duration TEXT NOT NULL;");
        ...
        private Task VerifyDataIntegrity(ComplexEntity original, ComplexEntity retrieved)
        {
            ...
            if (timeDiff > 1000) // Allow 1 second difference for MySQL precision
            {
