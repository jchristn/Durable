namespace Test.MySql
{
    ...
    /// <summary>
    /// Tests for boolean value conversion in MySqlDataTypeConverter.
    /// Verifies that various input formats (numeric, string) are correctly converted to boolean values.
    /// MySQL stores booleans as TINYINT(1), so this tests the conversion from various numeric and string formats.
    /// </summary>
    public class BooleanConversionTests
    {
        private readonly MySqlDataTypeConverter _Converter;
        ...
        {
            _Converter = new MySqlDataTypeConverter();
        }

        // ==================== NUMERIC TO BOOLEAN TESTS ====================

        /// <summary>
        /// Tests that sbyte 1 converts to true (MySQL TINYINT(1) returns sbyte).
        /// </summary>
        [Fact]
        ...
        /// <summary>
        /// Tests that sbyte 1 converts to true for nullable bool.
        /// </summary>
        [Fact]
        public void ConvertFromDatabase_SbyteOne_ReturnsTrueForNullableBool()
        {
            object? result = _Converter.ConvertFromDatabase((sbyte)1, typeof(bool?));
        ...
        // ==================== CONVERT TO DATABASE TESTS ====================

        /// <summary>
        /// Tests that true converts to sbyte 1 for MySQL TINYINT(1).
        /// </summary>
        [Fact]
        public void ConvertToDatabase_True_ReturnsSbyteOne()
        {
            object result = _Converter.ConvertToDatabase(true, typeof(bool));
            Assert.IsType<sbyte>(result);
            Assert.Equal((sbyte)1, result);
        }

        /// <summary>
        /// Tests that false converts to sbyte 0 for MySQL TINYINT(1).
        /// </summary>
        [Fact]
        public void ConvertToDatabase_False_ReturnsSbyteZero()
        {
            object result = _Converter.ConvertToDatabase(false, typeof(bool));
            Assert.IsType<sbyte>(result);
