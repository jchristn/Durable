namespace Test.MySql
{
    ...
    /// </summary>
    public class MySqlComplexExpressionTests : IDisposable
    {
        #region Private-Members

        private const string TestConnectionString = "Server=localhost;Database=durable_expression_test;User=test_user;Password=test_password;";
        ...
        /// </summary>
        public MySqlComplexExpressionTests()
        {
            lock (_TestLock)
            {
        ...
        private void SetupTestDatabase()
        {
            try
            {
                ...
                Console.WriteLine("✅ MySQL complex expression tests enabled - database connection successful");
            }
            catch (Exception ex)
            {
                Console.WriteLine($"⚠️  MySQL complex expression tests disabled - could not connect to database: {ex.Message}");
                Console.WriteLine("To enable MySQL complex expression tests:");
