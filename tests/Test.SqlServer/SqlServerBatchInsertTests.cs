namespace Test.SqlServer
{
    ...
    /// <summary>
    /// Comprehensive performance and configuration tests for SQL Server batch insert operations including:
    ...
    /// </summary>
    public class SqlServerBatchInsertTests : IDisposable
    {
        private readonly ITestOutputHelper _output;
        private readonly string _connectionString;
        private readonly bool _skipTests;

        public SqlServerBatchInsertTests(ITestOutputHelper output)
        {
            _output = output;
            _connectionString = "Server=view.homedns.org,1433;Database=durable_batch_test;User=sa;Password=P@ssw0rd4Sql;TrustServerCertificate=true;Encrypt=false;";
        ...
        /// <summary>
        /// Tests the batch insert configuration with different parameter limits for SQL Server optimization.
        /// </summary>
        ...
        /// <summary>
        /// Creates or recreates the people table with proper SQL Server schema.
        /// </summary>
        private async Task CreateTableAsync(SqlServerRepository<Person> repository)
        {
        ...
        /// </summary>
        private async Task SetupDatabase(SqlServerRepository<Person> repository)
        {
            await repository.ExecuteSqlAsync(@"
                IF OBJECT_ID('dbo.people', 'U') IS NOT NULL DROP TABLE people;
                CREATE TABLE people (
                    id INT IDENTITY(1,1) PRIMARY KEY,
                    first VARCHAR(100) NOT NULL,
                    last VARCHAR(100) NOT NULL,
